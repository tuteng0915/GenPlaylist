...
- [x] Pass cue vocabulary terms through WP-C.
...
- [x] Add a reusable WP-A → WP-D → WP-C pipeline object with one-time artifact loading.
...
## Remaining / blocked by WP-D checkpoint
